...
{
    public class SceneLoaderCondenced: IInitializeSystem
    {
        ...
        public SceneLoaderCondenced(Dictionary<string, Scene> scenes,
        ...
        {
            SceneConstructCondenced sceneConstruct = JsonConvert.DeserializeObject<SceneConstructCondenced>(File.ReadAllText(file));
        ...
        private void _LoadSystemPools(SceneConstructCondenced sceneConstruct, Scene newScene)
        {
        ...
        private void _LoadEntities(SceneConstructCondenced sceneConstruct, Scene newScene)
        {
            ...
            foreach(EntityConstructCondenced entityConstruct in sceneConstruct.Entities)
            {
        ...
        private Entity _GetEntity(EntityConstructCondenced entityConstruct, Scene newScene)
        {
        ...
        private void _RemoveComponentsFromEntity(EntityConstructCondenced entityConstruct, Entity newEntity)
        {
        ...
        private void _AddComponentsToEntity(EntityConstructCondenced entityConstruct, Entity newEntity)
        {
        ...
        public class EntityConstructCondenced
        {
        ...
        public class SceneConstructCondenced
        {
            public string Name { get; set; }
            public List<string> SystemPools { get; set; }
            public List<EntityConstructCondenced> Entities { get; set; }
        }
    }
