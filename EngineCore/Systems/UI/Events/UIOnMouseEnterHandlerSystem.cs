...
{
    public class UIOnMouseEnterHandlerSystem: GroupExecuteSystem, IInitializeSystem
    {
        private ScriptManager _scriptManager;
        private InputManager _inputManager;
        private UIOnClickLoaderSystem _scriptLoader;

        public UIOnMouseEnterHandlerSystem(Scene scene, InputManager inputManager, ScriptManager scriptManager) : base(scene)
        {
